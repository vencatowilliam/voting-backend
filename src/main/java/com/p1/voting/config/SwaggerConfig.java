...
public class SwaggerConfig {
	...
	private Info apiInfo() {
		return new Info().title("Backend Spring - VOTING API").description("VOTING API").version("v1")
				.license(new License().name("Apache 2.0").url("http://springdoc.org"))
				.contact(new Contact().name("William Vencato").url("https://github.com/vencatowilliam")
						.email("williamvencato@gmail.com"));
	}
